...
int main()
{
	...
	char weightfile[100] = "C:\\Users\\ASUS\\Desktop\\temp_data\\data\\Yolo_v1\\extraction.conv.weights";
	char filename[100] = "C:\\Users\\ASUS\\Desktop\\temp_data\\darknet\\DarkNet\\darknet\\data\\test_4.jpg";
	//	char train_images[40] = "/data/voc/train.txt";
	//	char backup_directory[40] = "/home/pjreddie/backup/";

	train_yolo(cfgfile, weightfile);
...
void train_yolo(char *cfgfile, char *weightfile)
{
	char train_images[100] = "C:\\Users\\ASUS\\Desktop\\temp_data\\VOC_label\\train.txt";
	char backup_directory[100] = "\\data\\";
	srand(time(0));
